...
public class GoodDataHttpClientIntegrationTest {
    ...
    @Test
    public void getProjectsBadLogin() throws IOException, ParseException {
        mock401OnProjects();
        mock401OnToken();
    ...
    @Test
    public void redirect() throws IOException, ParseException {
        onRequest()
                .havingMethodEqualTo("GET")
    ...
    @Test
    public void getProjectOkNoTtRefresh() throws IOException, ParseException {
    ...
    @Test
    public void shouldLogoutOk() throws IOException, ParseException {
        mock401OnProjects();
        mock200OnProjects();
